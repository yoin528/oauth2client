...
public class AuthAccessToken implements Serializable {
    ...
    public AuthAccessToken setClientId(String clientId) {
    ...
    public AuthAccessToken setClientSecret(String clientSecret) {
    ...
    public AuthAccessToken setGrantType(String grantType) {
    ...
    public AuthAccessToken setCode(String code) {
        this.code = code;
        return this;
    }
    ...
    public AuthAccessToken setRedirectUri(String redirectUri) {
    ...
    public AuthAccessToken setAccessTokenUri(String accessTokenUri) {
